...
// Directory
const int WAD_NAME = 8;			// Length of a directory entry name
...
// Textures
const int WAD_TEX_NAME  = 8;		// Length of a texture name
const int WAD_FLAT_NAME = WAD_NAME;	// Length of a flat name
const int WAD_PIC_NAME  = WAD_NAME;	// Length of a patch or sprite name
